namespace PoolIt.Services.Tests
{
    ...
    {
        #region GetPersonalDataForUserJson_Tests

        [Fact]
        public async Task GetPersonalDataForUserJson_WithCorrectUserId_WorksCorrectly()
        {
            // Arrange
            const string expectedJson = "{\"FirstName\": \"FirstName\",\"LastName\": \"LastName\",\"Email\": \"testuser@example.com\"," +
            ...
            var personalDataService = new PersonalDataService(new EfRepository<PoolItUser>(context), null, null, null);
        ...
        public async Task DeleteUser_WithCorrectUserId_WorksCorrectly()
        {
            ...
            var personalDataService = new PersonalDataService(new EfRepository<PoolItUser>(context), new EfRepository<JoinRequest>(context),
                new EfRepository<UserRide>(context), new EfRepository<Conversation>(context));
        ...
        public async Task DeleteUser_WithExceptionOnSave_ReturnsFalse()
        {
            ...
            var personalDataService = new PersonalDataService(mockUsersRepository.Object, new EfRepository<JoinRequest>(context),
                new EfRepository<UserRide>(context), new EfRepository<Conversation>(context));
